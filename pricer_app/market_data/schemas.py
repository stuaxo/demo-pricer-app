...
from pricer_app.market_data.business_rules import (
    validate_exchange_code, ContractNotationParser,
)
...
class MarketDataCreate(BaseModel):
    ...
    contract: str
    pricing_model: str
    market_data: Dict[str, Union[float, Dict[str, float]]]
...
class MarketDataRetrieve(BaseModel):
    """
